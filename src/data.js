...
const curatedOrders = [
  ...
  },
  {
    ...
    address: 'Marine Drive, Kochi 682031', placed: '12 Jun 2026 · 09:20', ts: Date.parse('2026-06-12T09:20:00'),
    statusKey: 'received', status: 'Received', tone: 'green', station: 'STORE-RECV-1', value: '₹1.95L', valNum: 195000,
    items: [
      { sku: 'SKU 4472', name: 'Diamond pendant', qty: 1, condition: 'verified' },
      { sku: 'SKU 4531', name: 'Cocktail ring', qty: 1, condition: 'verified' },
      { sku: 'SKU 4540', name: 'Gold coin · 8g', qty: 3, condition: 'verified' },
    ],
    timeline: [
      { label: 'Challan raised', time: '10 Jun · 09:00', who: 'warehouse', clip: false },
      { label: 'Packed · Warehouse', time: '10 Jun · 11:30', who: 'Priya · PACK-BENCH-1', clip: true },
      { label: 'Dispatched → Gati', time: '10 Jun · 14:20', who: 'auto', clip: false },
      { label: 'Received · Store', time: '12 Jun · 09:20', who: 'Sana · STORE-RECV-1', clip: true },
      { label: 'Shelved', time: '12 Jun · 09:55', who: 'Sana', clip: false },
    ],
    custom: { ...blankCustom, insured: '₹2.00L', notes: 'All RFIDs matched on arrival — shelved.' },
    remarks: [{ who: 'Sana', time: '12 Jun · 09:58', text: 'Clean receipt, every line ticked.' }],
  },
  {
    id: 'DC-2026-00448', channel: 'B2B', customer: 'Delhi CP Store', phone: '+91 11 4900 2200',
    address: 'Connaught Place, New Delhi 110001', placed: '11 Jun 2026 · 10:15', ts: Date.parse('2026-06-11T10:15:00'),
    statusKey: 'received', status: 'Received · short', tone: 'amber', station: 'STORE-RECV-2', value: '₹5.20L', valNum: 520000,
    items: [
      { sku: 'SKU 4530', name: 'Diamond choker', qty: 1, condition: 'verified' },
      { sku: 'SKU 4550', name: 'Kundan necklace set', qty: 1, condition: 'verified' },
      { sku: 'SKU 4601', name: 'Temple jewellery set', qty: 1, condition: 'missing' },
      { sku: 'SKU 4480', name: 'Gold bangle', qty: 2, condition: 'verified' },
    ],
    timeline: [
      { label: 'Challan raised', time: '09 Jun · 08:40', who: 'warehouse', clip: false },
      { label: 'Packed · Warehouse', time: '09 Jun · 11:10', who: 'Mira · PACK-BENCH-2', clip: true },
      { label: 'Dispatched → Gati', time: '09 Jun · 15:00', who: 'auto', clip: false },
      { label: 'Received · Store', time: '11 Jun · 10:15', who: 'Devang · STORE-RECV-2', clip: true },
    ],
    custom: { ...blankCustom, insured: '₹5.40L', notes: 'Short by 1 — Temple set not in carton; flagged to warehouse.' },
    remarks: [{ who: 'Devang', time: '11 Jun · 10:20', text: 'Temple jewellery set missing — raised short with the arrival video.' }],
  },
  {
    id: 'RFID-1075', channel: 'Store', customer: 'Hyderabad Banjara', phone: '+91 40 4012 9900',
    address: 'Banjara Hills, Hyderabad 500034', placed: '13 Jun 2026 · 12:30', ts: Date.parse('2026-06-13T12:30:00'),
    statusKey: 'received', status: 'Received', tone: 'green', station: 'STORE-RECV-1', value: '₹0.95L', valNum: 95000,
    items: [
      { sku: 'SKU 4571', name: 'Ruby cocktail ring', qty: 1, condition: 'verified' },
      { sku: 'SKU 4590', name: 'Pearl drop pendant', qty: 1, condition: 'verified' },
    ],
    timeline: [
      { label: 'Challan raised', time: '11 Jun · 09:30', who: 'warehouse', clip: false },
      { label: 'Packed · Warehouse', time: '11 Jun · 12:05', who: 'Rahul · PACK-BENCH-1', clip: true },
      { label: 'Dispatched → Gati', time: '11 Jun · 16:10', who: 'auto', clip: false },
      { label: 'Received · Store', time: '13 Jun · 12:30', who: 'Devang · STORE-RECV-1', clip: true },
      { label: 'Shelved', time: '13 Jun · 13:00', who: 'Devang', clip: false },
    ],
    custom: { ...blankCustom, insured: '₹1.00L', notes: 'Received and shelved, no discrepancies.' },
  },
  {
    id: 'RFID-1082', channel: 'Store', customer: 'Chennai Express Ave', phone: '+91 44 4002 8800',
    address: 'Express Ave, Chennai 600002', placed: '14 Jun 2026 · 10:30', ts: Date.parse('2026-06-14T10:30:00'),
    statusKey: 'receiving', status: 'Receiving', tone: 'amber', station: 'STORE-RECV-1', value: '₹3.70L', valNum: 370000,
    items: [
      { sku: 'SKU 4510', name: 'Polki necklace', qty: 1, condition: 'pending' },
      { sku: 'SKU 4560', name: 'Diamond stud earrings', qty: 2, condition: 'pending' },
      { sku: 'SKU 4612', name: 'Sapphire ring', qty: 1, condition: 'pending' },
    ],
    timeline: [
      { label: 'Challan raised', time: '12 Jun · 08:50', who: 'warehouse', clip: false },
      { label: 'Packed · Warehouse', time: '12 Jun · 11:25', who: 'Priya · PACK-BENCH-2', clip: true },
      { label: 'Dispatched → Gati', time: '12 Jun · 15:40', who: 'auto', clip: false },
      { label: 'Arrived at store', time: '14 Jun · 10:30', who: 'Sana · STORE-RECV-1', clip: false },
    ],
    custom: { ...blankCustom, insured: '₹3.80L', slot: '—', instructions: 'Scan each RFID at the desk to receive.', notes: 'Receiving in progress — confirm to shelve.' },
    remarks: [{ who: 'Sana', time: '14 Jun · 10:33', text: 'Carton opened — scanning RFIDs against the challan.' }],
  },
  {
    id: 'DC-2026-00461', channel: 'B2B', customer: 'Vadodara Branch', phone: '+91 265 401 3300',
    address: 'Alkapuri, Vadodara 390007', placed: '14 Jun 2026 · 08:15', ts: Date.parse('2026-06-14T08:15:00'),
    statusKey: 'receiving', status: 'Receiving', tone: 'amber', station: 'STORE-RECV-2', value: '₹7.40L', valNum: 740000,
    items: [
      { sku: 'SKU 4530', name: 'Diamond choker', qty: 1, condition: 'pending' },
      { sku: 'SKU 4601', name: 'Temple jewellery set', qty: 2, condition: 'pending' },
      { sku: 'SKU 4550', name: 'Kundan necklace set', qty: 1, condition: 'pending' },
      { sku: 'SKU 4471', name: 'Solitaire ring', qty: 2, condition: 'pending' },
    ],
    timeline: [
      { label: 'Challan raised', time: '12 Jun · 09:05', who: 'warehouse', clip: false },
      { label: 'Packed · Warehouse', time: '12 Jun · 12:15', who: 'Mira · PACK-BENCH-1', clip: true },
      { label: 'Dispatched → Gati', time: '12 Jun · 16:30', who: 'auto', clip: false },
      { label: 'Arrived at store', time: '14 Jun · 08:15', who: 'Devang · STORE-RECV-2', clip: false },
    ],
    custom: { ...blankCustom, insured: '₹7.60L', slot: '—', instructions: 'High-value consignment — reconcile every RFID before shelving.', notes: 'Receiving in progress.' },
  },
  {
    id: 'RFID-1090', channel: 'Store', customer: 'Indore Store', phone: '+91 731 400 6600',
    address: 'MG Road, Indore 452001', placed: '15 Jun 2026 · 09:40', ts: Date.parse('2026-06-15T09:40:00'),
    statusKey: 'receiving', status: 'Receiving', tone: 'amber', station: 'STORE-RECV-1', value: '₹1.60L', valNum: 160000,
    items: [
      { sku: 'SKU 4521', name: 'Mangalsutra', qty: 1, condition: 'pending' },
      { sku: 'SKU 4540', name: 'Gold coin · 8g', qty: 4, condition: 'pending' },
    ],
    timeline: [
      { label: 'Challan raised', time: '13 Jun · 10:10', who: 'warehouse', clip: false },
      { label: 'Packed · Warehouse', time: '13 Jun · 13:00', who: 'Rahul · PACK-BENCH-2', clip: true },
      { label: 'Dispatched → Gati', time: '13 Jun · 17:00', who: 'auto', clip: false },
      { label: 'Arrived at store', time: '15 Jun · 09:40', who: 'Sana · STORE-RECV-1', clip: false },
    ],
    custom: { ...blankCustom, insured: '₹1.70L', slot: '—', instructions: 'Scan to receive — small parcel.', notes: 'Receiving — single carton.' },
  },
  {
